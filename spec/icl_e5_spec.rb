...
describe "ICL Example 5 from the 1687 spec" do
  ...
  it 'the connections are hooked up' do
    net = IJTAG.import(file: file).instantiate("Daisy_3WI")
    net.si.to.path.should == "WI1.SI"
    net.wi1.si.from.path.should == "SI"
    net.wi1.so.to.path.should == "WI2.SI"
    net.wi2.si.from.path.should == "WI1.SO"
    net.wi2.so.to.path.should == "WI3.SI"
    net.wi3.si.from.path.should == "WI2.SO"
    net.wi3.so.to.path.should == "SO"
    net.so.from.path.should == "WI3.SO"

    # Verify a couple of deep connections
    net.wi1.reg8.do.to.path.should == "WI1.I1.DI"
    net.wi3.reg8.sr.si.from.path.should == "WI3.reg8.SI"
